      ...
      <div className="w-full h-full rounded-lg bg-black/50 flex items-center ">
        <div className="max-w-7xl mx-auto px-6 text-white">
          ...
          <div className="flex gap-4">
            <Link href="#">
              <Button className="bg-linear-to-r from-pink-500 via-purple-500 bg-red-500 px-5 py-2 font-bold cursor-pointer active:scale-99 rounded-full">
                Generate Now
              </Button>
            </Link>

            <Link href="/pricing">
              <Button variant="outline" className="bg-[#ffffff40] rounded-[25px] py-2 px-3 cursor-pointer font-semibold ">
                View Pricing
              </Button>
            </Link>
          </div>
